...
urlpatterns = [
    ...
    path('product/<int:tig_id>/', views.RedirectionDetailProduit.as_view()),
    ...
    path('shipPoint/<int:tig_id>', views.RedirectionShipPointDetails.as_view()),
    ...
    path('update_stock/<int:tig_id>/', views.UpdateProductStock.as_view(), name='update_stock'),
